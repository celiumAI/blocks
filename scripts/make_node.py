...
doc_path = base_dir + "docs/modules/node.md"
print(doc_path)
...
stamped_script = stamped_script.replace("THIS_PARENT_AP_SSID", os.getenv("PARENT_AP_SSID"))

print(os.getenv("PARENT_AP_PASSWORD"))
stamped_script = stamped_script.replace("THIS_PARENT_AP_PASSWORD", os.getenv("PARENT_AP_PASSWORD"))
...
with open(base_dir + 'src/node_generated.cpp', 'w') as f:
